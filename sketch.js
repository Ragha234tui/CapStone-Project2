...
function setup() 
{
  ...
  bunny = createSprite(360,620,100,100);
  bunny.scale = 0.2;
  ...
  star2 = createSprite(370,370,20,20)
  star2.addImage(star_img)
  star2.scale = 0.02

  button3 = createImg("baloon2.png")
  button3.position(230,370)
  button3.size(120,120)
  button3.mouseClicked(airBlow)


  button4 = createImg("balloon.png")
  button4.position(70,270)
  button4.size(120,120)
  button4.mouseClicked(airBlow)
